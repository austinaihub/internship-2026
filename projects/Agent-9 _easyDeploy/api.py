...
# CORS is still useful for local dev mode (npm run dev on :5173)
app.add_middleware(
    CORSMiddleware,
...
# ---------------------------------------------------------------------------
# Serve pre-built React frontend (production / green-deploy mode)
# ---------------------------------------------------------------------------
...
if FRONTEND_DIR.exists():
    # Serve JS/CSS/assets from the Vite build
