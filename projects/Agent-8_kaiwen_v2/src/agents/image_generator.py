...
class ImageGeneratorAgent:
    ...
    def generate_image(self, state: AgentState):
        ...
        prompt_maker = ChatPromptTemplate.from_template(
            ...
            - People, faces, and full figures ARE allowed and encouraged
            ...
            - Minimal incidental text on objects is OK; do NOT add large headlines or captions
    ...
    # ------------------------------------------------------------------
    # Phase 2: National Geographic-style text compositing
    # ------------------------------------------------------------------
